...
$sql="INSERT INTO `edu`.`stu` (`Name`, `Age`, `Gender`, `Email`, `phone`, `desc`, `date`) VALUES ( '$Name', '$Age', '$Gender', '$Email', '$phone', '$desc', current_timestamp())";
...
<body>
    <img class="bg" src="vit.jpg" alt="IIT Kharagpur">
    <div class="container">
